      ...
      <div className="container mx-auto flex justify-center ">
        {
          [allSlots[len-1]] ? [allSlots[len-1]].map((ele, index) => (
            <div key={index} className="mt-10 bg-gray-300 p-5 rounded shadow-md w-[350px]  text-gray-700 text-lg font-semibold ">
              ...
              <h1 className="mb-3">Date : <span className="font-bold text-gray-800 mx-5">{ele?.date}</span></h1>
              <h1 className="mb-3">From : <span className="font-bold text-gray-800 mx-5">{ele?.from}</span></h1>
              <h1 className="mb-3">To : <span className="font-bold text-gray-800 mx-5">{ele?.to}</span></h1>
