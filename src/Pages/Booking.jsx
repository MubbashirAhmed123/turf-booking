                ...
                display ? <BookinForm selectedTurf={selectedTurf} />
                    ...
                    <div>
                        ...
                        <div className='mt-10 p-5 flex flex-wrap justify-around items-center gap-10'>
                            {
                                turf.map((turf, index) => (
                                    <div className='bg-gray-300  rounded-md shadow-md shadow-black/35   p-5 hover:scale-105 transition cursor-pointer' key={index}>
                                        <img src={turf.img} alt="" className='w-[250px] h-[200px] object-cover mb-5' />
                                        ...
                                        <button className='mt-5 bg-blue-400 py-2 px-2 rounded shadow-sm font-semibold hover:bg-blue-500 hover:text-blue-900 transition' onClick={() => handleClick(turf)}>Book Slot</button>
                                    </div>
                                ))
                            }
                        </div>
